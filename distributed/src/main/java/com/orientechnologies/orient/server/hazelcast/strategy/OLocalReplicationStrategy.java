...
/**
 * Local replication strategy: always returns the local node as master.
 * 
 * @author Luca Garulli (l.garulli--at--orientechnologies.com)
 * 
 */
public class OLocalReplicationStrategy implements OReplicationStrategy {
  @Override
  public String getMasterNode(final ODistributedServerManager iManager, final String iClusterName, final Object iKey) {
    final Member member = ((OHazelcastPlugin) iManager).getHazelcastInstance().getCluster().getLocalMember();
